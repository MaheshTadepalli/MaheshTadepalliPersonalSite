...
export async function getGitHubRepos(username: string = "MaheshTadepalli"): Promise<GitHubRepo[]> {
    try {
...
export async function getPinnedRepos(username: string = "MaheshTadepalli"): Promise<GitHubRepo[]> {
...
export async function getGitHubStats(username: string = "MaheshTadepalli") {
    try {
