...
export const projectsData: Project[] = [
    {
        ...
        problem: "Campus exploration needs contextual campus data that is visible in the user's real-world view instead of being limited to static maps.",
        solution: "Developed a mobile AR data visualization system using Unity, ARCore, and C#, integrating GPS, compass, and camera tracking for real-time overlays of campus points of interest.",
        techStack: ["Unity", "ARCore", "C#", "GPS", "Compass", "Computer Vision", "Location Data"],
        challenges: [
            "Fusing sensor data from GPS, compass, and camera tracking",
            "Aligning location data with AR overlays",
            "Designing an interactive interface for campus point-of-interest exploration",
        ],
        outcome: "Built an AR-based exploration experience that displays campus data directly through a smartphone interface.",
        featured: true,
    },
    {
        title: "Flood Risk Prediction and Big Data Mapping Using Machine Learning",
        period: "Jan 2026 - Apr 2026",
        problem: "Flood risk assessment requires time-aware analysis of rainfall trends and interpretable big-data outputs for regional decision-making.",
        ...
        techStack: ["Python", "Machine Learning", "Logistic Regression", "Decision Tree", "Random Forest", "Big Data Visualization"],
        challenges: [
        ...
        outcome: "Produced interpretable flood-risk predictions and big-data visualizations that connect rainfall history with regional risk mapping.",
        featured: true,
    },
    {
